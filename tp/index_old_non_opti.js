...
if(program.characters) { // Programme lancé avec la commande marvel -c
  ...
  .fail(console.error)
  .done()
}else if (program.database) { // Programme lancé avec la commande marvel -d
  db.open('marvel.db').then(() => {
  ...
  // console.log(db);
}else if (program.main) { // Programme lancé avec la commande marvel -m
